    ...
    <div className="pt-20 min-h-[calc(100vh-80px)] md:min-h-[calc(100vh-80px)] bg-[#faf6e8] bg-cover bg-center flex flex-col justify-center py-6 relative" style={{ backgroundImage: "url('/marble-bg.jpg')" }}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full flex flex-col space-y-6 lg:space-y-8">
        ...
        <div className="text-center space-y-1.5 max-w-3xl mx-auto">
          <span className="font-serif italic text-[#b8922b] tracking-[0.25em] text-[10px] sm:text-xs uppercase block select-none">Kind Words</span>
          <h1 className="font-serif text-2xl sm:text-3xl lg:text-4xl font-bold text-[#3a1906] tracking-wide uppercase select-none">
            Client Testimonials
          </h1>
          <div className="w-12 h-[1.5px] bg-[#3a1906]/30 mx-auto mt-2" />
        </div>
        ...
        <div className="w-full max-w-5xl mx-auto px-4">
          ...
          <div className="hidden md:flex relative items-center justify-center">
            ...
            {/* Avatar Frame */}
            <div className="w-[360px] h-[360px] lg:w-[400px] lg:h-[400px] rounded-3xl overflow-hidden border border-[#deb18a]/50 shadow-2xl flex-shrink-0 bg-white/50 p-2 z-0 relative">
            ...
            <div className="bg-[#faf6e8]/95 backdrop-blur-md border border-[#deb18a]/50 rounded-3xl shadow-xl p-6 lg:p-8 ml-[-60px] z-10 max-w-md lg:max-w-lg flex-1 relative">
              
              {/* Elegant Sparkle decoration */}
              <div className="absolute top-5 right-5 opacity-30 text-[#b8922b] pointer-events-none">
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  <div className="mb-4">
                    <h2 className="text-xl lg:text-2xl font-bold font-serif text-[#3a1906] mb-1">
                      {currentTestimonial.name}
                    </h2>
                    <p className="text-[11px] font-semibold text-[#b8922b] uppercase tracking-wider">
                      {currentTestimonial.title}
                    </p>
                  </div>

                  <blockquote className="text-[#3a1906]/90 text-xs lg:text-sm leading-relaxed mb-6 italic font-medium border-l-2 border-[#b8922b]/50 pl-4 py-0.5">
                  ...
                  <div className="flex space-x-3">
                    {socialIcons.map(({ icon: IconComponent, url, label }) => (
                      <a
                        ...
                        className="w-9 h-9 bg-[#3a1906] hover:bg-[#b8922b] text-white rounded-full flex items-center justify-center transition-all hover:scale-105 cursor-pointer shadow-md"
                        aria-label={label}
                      >
